...
<?php
     ...
     $video = array('grassitup furniture.mp4','Comp 2.mp4','Cap.mp4','Comp 4.mp4');
                    ...
                    <div class="mask">
						...
						<ul class="nav nav-inline bordernomob bgtopmob">
							<li class="nav-item mob-nav">
								<a class="nav-link navmob-font active" href="#tab-products-1" data-toggle="tab">Hot Deals 123 <span class="" style="margin-left:10px"> عروض مميزة‎</a>
							</li>
							<li class="nav-item mob-nav">
...
<div class="loozaahala"><a href="https://loozaa.com"><img src="assets/images/halasale-final.jpg"></a></div> -->
