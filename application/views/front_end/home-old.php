...
<div class="full-wrap slider-sec">
  <ul class="social_icons" id="fixed-social">
    <li><a href="" target="_blank"   title="Facebook" data-placement="bottom" data-original-title="Facebook"><i class="fa fa-facebook" aria-hidden="true"></i> </a></li>
    ...
    <li><a href="" target="_blank"  data-placement="bottom" title="Youtube" data-original-title="Youtube"><i class="fa fa-youtube" aria-hidden="true"></i> </a></li>
  </ul>
  <div class="container">
    <div class="row">
      <div class="col-md-8 pull-left">
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active"> <img class="d-block img-fluid" src="assets/front_end/images/1.jpg" alt="Second slide">
...
Your browser does not support the video tag.
      ...
      <div class="col-md-4 add-wrap pull-right indexcolleft">
        <section class="box-typical hero-radius">
          <div class="box-typical-header hero-radius">Hot Deals</div>
          <?php if($hotdeals){
          ...
          <div class="list-item"> <a href="<?php echo @$link; ?>" >
            <div class="item-row">
              <div class="tbl-row">
                ...
                <div class="content">
                  <div class="head"><?php echo substr($val->title_en,0,30).'...'; if($val->offer_price!=0 || $val->offer_price!=''){ ?> <span><?php echo $currency.' '.number_format(@$val->offer_price, 2); ?></span>
                    <?php }elseif($val->price!=0 || $val->price!=''){ ?>
                    <span><?php echo $currency.' '.number_format(@$val->price, 2); ?></span>
                    <?php } ?>
                  </div>
        ...
        <section class="box-typical hero-radius">
          <div class="box-typical-header hero-radius">Latest Posts</div>
          <?php if($latestpost){ foreach($latestpost as $val){
			  $title = preg_replace("/[^a-zA-Z0-9 ]+/", "", $val->title_en);
			  $title = str_replace('  ',' ',strtolower($title));
			  $title = str_replace(' ','-',$title);
			  $latest = $title.'-'.$val->id;
        ...
        <section class="box-typical hero-radius">
          <div class="box-typical-header hero-radius">Special Offers</div>
          <?php if($special){ foreach($special as $val){
			  $title = preg_replace("/[^a-zA-Z0-9 ]+/", "", $val->title_en);
			  $title = str_replace('  ',' ',strtolower($title));
			  $title = str_replace(' ','-',$title);
			  $latest = $title.'-'.$val->id;
        ...
        <div class="full-wrap m-t-15 typical-add-right"> <img src="assets/front_end/images/linkmedia3.jpg" class="img-fluid"> </div>
      </div>
