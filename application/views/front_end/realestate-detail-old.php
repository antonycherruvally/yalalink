  ...
  <div class="full-wrap store-detail-wrap">
    <div class="row node-breadcrumb text-muted">
      <ol class="breadcrumb">
        ...
        <li><a href="real-estate?property-type=<?php echo $view->property_type; ?>&type=New"><?php echo $view->cat; ?></a></li>
    ...
    <h3 class="store-price"><?php echo @$currency; ?>
      <?php if($view->offer_price!=0) { echo number_format(@$view->offer_price); }else{ echo number_format(@$view->price); }?>
      <span>
      <?php if($view->offer_price!=0) { echo number_format(@$view->price); }?>
      </span></h3>
    <div class="full-wrap store-detail-box-wrap">
      <?php /*?><div class="col-md-6 store-detail-box inline-block hero-radius">
        <div class="head">
      ...
      <div class="col-md-6 store-detail-box inline-block hero-radius">
        <div class="head">
          <figure><i class="fa fa-check-square-o" aria-hidden="true"></i></figure>
          <i>Amenities</i></div>
        <ul class="list-inline row gnralbox amentity-box-wrap">
          ...
          <li class="amentity-box inline-block">
            <p> <span><i class="show_color"><?php echo $title->name; ?></i></span> </p>
          </li>
          <?php } } ?>
        </ul>
      </div>
