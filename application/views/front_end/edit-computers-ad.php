    ...
    <div class="row" style="margin-top: 50px;border: 1px solid #4fc3c533;margin-bottom: 15px;padding: 18px;">
      <div class="col-md-12">
        <div class="post-ad-wrap">
             ...
             <h3 style="color:black;">Update Your Computers Ad </h3>
            
              <form class="m-t-15" action="updateComputers" enctype="multipart/form-data" method="post" name="post-form" id="post-form">
