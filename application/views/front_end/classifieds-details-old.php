  ...
  <div class="full-wrap store-detail-wrap">
    <div class="row node-breadcrumb text-muted">
      <ol class="breadcrumb">
       <li><a href="index">Home</a></li>
        ...
        <li><a href="classifieds?category=<?php echo $view->category; ?>&type=<?php echo $view->type; ?>"><?php echo $view->cat; ?></a></li>
        <li><a href="classifieds?category=<?php echo $view->category; ?>&type=<?php echo $view->type; ?>"><?php echo $view->subcat; ?></a></li>
    ...
    <div class="full-wrap store-detail-box-wrap"> 
      ...
      <div class="col-md-6 store-detail-box inline-block hero-radius">
        <div class="head">
          <figure><i class="fa fa-product-hunt" aria-hidden="true"></i></figure>
          <i>Details</i></div>
        <ul class="list-inline row gnralbox">
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label>Category:</label>
              <span><i class="show_color"><?php echo @$view->cat; ?></i></span> </p>
          </li>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label>Sub Category:</label>
              <span><i class="show_color"><?php echo @$view->subcat; ?></i></span> </p>
          </li>
			<?php if($view->mobile){ ?>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
...
<!-- col data-toggle="modal" data-target="#sendMail"-->
