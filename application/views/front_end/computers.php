...
<div class="ultypes" style="display:none;">
          <li class="nav-item"> <a class="nav-link link-radius <?php if($this->input->get('type')=='Used'){ echo 'active'; }elseif($this->input->get('type')==''){ echo 'active'; } ?> type" id="Used" data-toggle="tab" href="#used" role="tab">Used</a> </li>
    <li class="nav-item"> <a class="nav-link <?php if($this->input->get('type')=='New'){ echo 'active'; } ?> type" id="New" data-toggle="tab" href="#new" role="tab">New</a> </li>
  </ul>
...
<?php $this->load->view('blocks/computerfilter.php');?>
                        ...
                        <main id="main" class="site-main">
                            ...
                            <div class="shop-control-bar">
                               ...
                               <ul class="shop-view-switcher nav nav-tabs tabtypes" role="tablist">
                                       <li class="typestab" ><a class="nav-link link-radius1 <?php if($this->input->get('type')=='Used'){ echo 'active'; }elseif($this->input->get('type')==''){ echo 'active'; } ?> type" id="Used" data-toggle="tab" href="#used" role="tab">Used</a>  </li>
                                       <li class="typestab1"><a class="nav-link link-radius1 <?php if($this->input->get('type')=='New'){ echo 'active'; } ?> type" id="New" data-toggle="tab" href="#new" role="tab">New</a> </li>
                                        </ul>
   ...
   <div class="tab-content">
            ...
            <?php } } ?>
                                    ...
                                    <ul>
                                        <li class="cat-item current-cat"><a href="product-category.html">Computers</a> <span class="count"></span>
                                            <ul class='children'>
                                                <li class="nav-item"> <a class="nav-link   <?php if($this->input->get('type')=='Used'){ echo 'active'; }elseif($this->input->get('type')==''){ echo 'active'; } ?> type" id="Used" data-toggle="tab" href="#used" role="tab">Computer & Laptop Accessories</a> </li>
                                                <li class="nav-item"> <a class="nav-link<?php if($this->input->get('type')=='New'){ echo 'active'; } ?> type" id="New" data-toggle="tab" href="#new" role="tab">Computer Parts & Components</a> </li>
    <li class="nav-item"> <a class="nav-link<?php if($this->input->get('type')=='New'){ echo 'active'; } ?> type" id="New" data-toggle="tab" href="#new" role="tab">Computers & Servers</a> </li>
    <li class="nav-item"> <a class="nav-link<?php if($this->input->get('type')=='New'){ echo 'active'; } ?> type" id="New" data-toggle="tab" href="#new" role="tab">Laptops & Netbooks</a> </li>
    <li class="nav-item"> <a class="nav-link<?php if($this->input->get('type')=='New'){ echo 'active'; } ?> type" id="New" data-toggle="tab" href="#new" role="tab">Networking & Accessories</a> </li>
     <li class="nav-item"> <a class="nav-link<?php if($this->input->get('type')=='New'){ echo 'active'; } ?> type" id="New" data-toggle="tab" href="#new" role="tab">Printers, Scanners, Hardware & Accessories</a> </li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
...
$(document).ready(function(e) {
	...
	$(document).on('click','.unfavorites',function(e){
        ...
        $.ajax({
            'url': '<?php echo base_url(); ?>computers/getListings?type='+type+'&category='+category+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>computers/getListingslistsmall?type='+type+'&category='+category+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>computers/getListingslist?type='+type+'&category='+category+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
