     ...
     <div class="row" style="margin-top: 50px;border: 1px solid #4fc3c533;margin-bottom: 15px;padding: 18px;">
      <div class="col-md-12">
        <div class="post-ad-wrap">
            ...
            <h3 style="color:black;">Update Your Classifieds Ad </h3>
            
              <form class="m-t-15" action="updateClassifieds" enctype="multipart/form-data" method="post" name="post-form" id="post-form">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" value="<?php echo $edit->price; ?>" class="form-control no-border mat-txt mat-font first-txt" id="price" name="price">
                    </div>
                  </div>
                </div>
                 <div class="row">
...
$(document).ready(function(e) {
    ...
    getSub($('#category').val(),<?php echo $details->subcategory; ?>);
