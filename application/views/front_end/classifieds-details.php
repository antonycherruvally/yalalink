...
<?php //$this->load->view('blocks/classifilter.php');?>
 ...
 <ul class="social_icons" id="fixed-social">
  ...
  <div class="row" id="slider-thumbs">
    <div class="col-md-12">
      <ul class="hide-bullets store-bullets classbullet">
          ...
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              ...
              <span><i class="show_color"><?php echo @$view->horsepower; ?></i></span> </p>
                                  ...
                                  <div class="detail-btn-wrap pos-center" style="margin-top: 68px;margin-left: -4px;"> 
<?php if($view->mobile){ ?>
       ...
       <ins class="adsbygoogle"
        ...
        <script>
            (adsbygoogle = window.adsbygoogle || []).push({});
                            ...
                            <?php $this->load->view('blocks/slider/similarads', ['category' => 'Classifieds']); ?>
                               <?php $this->load->view('blocks/slider/ualsolike',['category' => 'Classifieds']);?>
                        </div>
                </div><!-- /.container -->
