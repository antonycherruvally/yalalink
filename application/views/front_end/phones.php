                        ...
                        <aside class="widget woocommerce widget_product_categories electro_widget_product_categories">
                            <ul class="product-categories category-single">
                                <li class="product_cat">
                                    ...
                                    <ul>
                                        <li class="cat-item current-cat"><a href="product-category.html">Phones</a> <span class="count"></span>
                                           <!-- <ul class='children'>
                                                <li class="nav-item"> <a class="nav-link  <?php if($this->input->get('type')=='Used'){ echo 'active'; }elseif($this->input->get('type')==''){ echo 'active'; } ?> type" id="Used" data-toggle="tab" href="#used" role="tab">Used</a> </li>
...
$(document).ready(function(e) {
	...
	$(document).on('click','.unfavorites',function(e){
        ...
        $.ajax({
            'url': '<?php echo base_url(); ?>phones/getListings?type='+type,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>phones/getListingslist?type='+type,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>phones/getListingslistsmall?type='+type,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
