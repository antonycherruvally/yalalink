...
<div class="ultypes" style="display:none;">
            <ul class="nav nav-tabs listing-wrap healthcare-tabs" role="tablist">
    <li class="nav-item"> <a class="nav-link <?php if($this->input->get('type')=='Hospitals'){ echo 'active'; }elseif($this->input->get('type')==''){ echo 'active'; } ?> type" id="Hospitals" data-toggle="tab" href="#hospitals" role="tab"> Hospitals</a> </li>
    <li class="nav-item"> <a class="nav-link link-radius <?php if($this->input->get('type')=='Clinics'){ echo 'active'; } ?> type" id="Clinics" data-toggle="tab" href="#clinics" role="tab"> Clinics</a> </li>
    <li class="nav-item"> <a class="nav-link link-radius <?php if($this->input->get('type')=='Dental Hospitals'){ echo 'active'; } ?> type" id="Dental Hospitals" data-toggle="tab" href="#dentalhospitals" role="tab"> Dental Hospitals</a> </li>
    <li class="nav-item"> <a class="nav-link link-radius <?php if($this->input->get('type')=='Dentist'){ echo 'active'; } ?> type" id="Dentist" data-toggle="tab" href="#dentist" role="tab"> Dentist</a> </li>
  </ul>
  <input type="hidden" value="<?php if($this->input->get('type')){ echo $this->input->get('type'); }else{ echo 'Hospitals'; }?>" name="type" id="type">
</div>
   ...
   <div class="tab-content">
            ...
            <?php } } ?>
                                    ...
                                    <ul>
                                        <li class="cat-item current-cat"><a href="product-category.html">Health Care</a> <span class="count"></span>
                                            <ul class='children'>
                                                <li class="nav-item"> <a class="nav-link <?php if($this->input->get('type')=='Hospitals'){ echo 'active'; }elseif($this->input->get('type')==''){ echo 'active'; } ?> type" id="Hospitals" data-toggle="tab" href="#hospitals" role="tab">Hospitals</a> </li>
      <li class="nav-item"> <a class="nav-link  <?php if($this->input->get('type')=='Clinics'){ echo 'active'; } ?>type" id="Clinics" data-toggle="tab" href="#clinics" role="tab">Clinics</a> </li>
      <li class="nav-item"> <a class="nav-link <?php if($this->input->get('type')=='Dental Hospitals'){ echo 'active'; } ?>type" id="Dental Hospitals" data-toggle="tab" href="#dentalhospitals" role="tab"> Dental Hospitals</a> </li>
      <li class="nav-item"> <a class="nav-link <?php if($this->input->get('type')=='Dentist'){ echo 'active'; } ?> type" id="Dentist" data-toggle="tab" href="#dentist" role="tab">Dentist</a> </li>
...
$(document).ready(function(e) {
	...
	$(document).on('click','.unfavorites',function(e){
        ...
        $.ajax({
            'url': '<?php echo base_url(); ?>healthcare/getListings?type='+type+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>healthcare/getListingslist?type='+type+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>healthcare/getListingslistsmall?type='+type+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
	...
	$('.type').click(function(e) {
		...
		$('.result-div').hide();
        $.ajax({
            'url': '<?php echo base_url(); ?>healthcare/getListings?type='+type,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
