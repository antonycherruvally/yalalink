    ...
    <div class="row"  style="margin-top: 50px;border: 1px solid #4fc3c533;margin-bottom: 15px;padding: 18px;">
      <div class="col-md-12">
        <div class="post-ad-wrap">
            ...
            <h3 style="color:black;">Update Your Services Ad </h3>
            
              <form class="m-t-15" action="updateServices" enctype="multipart/form-data" method="post" name="post-form" id="post-form">
                  ...
                  <div class="col-md-12">
                    <label class="form-check-label mat-label-color" for="type">Choose Type:</label>
                      ...
                      <label class="radio-inline">
                        <input type="radio" name="type" id="type_1" value="Maintenance" <?php if($edit->type == 'Maintenance'){ echo 'checked'; }?>>
                        Maintenance </label>
                      <label class="radio-inline">
                        <input type="radio" name="type" id="type_2" value="Services" <?php if($edit->type == 'Services'){ echo 'checked'; }?>>
                        Services </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="form-control" name="category" id="category">
                        ...
                        <?php $category = getServicesCategories(); if($category){ foreach($category as $val){  ?>
                  ...
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" class="form-control no-border mat-txt mat-font first-txt" id="fax" name="fax">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" class="form-control no-border mat-txt mat-font first-txt" id="website" name="website">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
