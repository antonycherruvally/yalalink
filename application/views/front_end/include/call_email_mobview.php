...
<?php if($view->mobile){ ?>
<a href="javascript:void(0);" class="hero-button btn-shadow icon-btn call-show-nmb detail-btn btn-FF9800" x="<?php echo @$view->mobile; ?>"><i class="fa fa-phone bounce-ani" aria-hidden="true"></i>Call</a> 
<?php } ?>
<?php if($view->email){ ?>
<a href="javascript:void(0);" data-toggle="modal" data-target="#sendMail" data-toggle="tooltip" data-placement="top" title="Mail to <?php echo @$view->email; ?>" class="hero-button btn-shadow icon-btn detail-btn btn-FF9800"> <span><i class="fa fa-paper-plane bounce-ani" aria-hidden="true"></i>E-mail</span></a>
<?php } ?>
