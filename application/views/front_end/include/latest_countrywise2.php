<section class="box-typical hero-radius">
 <?php if($countrylatest2){

	 foreach($countrylatest2 as $val){
...
<!-- <h3 class="widget-title"><?php echo $main_category ?> <?php echo $c_code ?><img src="<?php echo $img ?>" style="margin-left: 10px;margin-left: 10px; width: 48px;height: 39px;margin-top: -9px;"><span style="margin-left: 7px;"><?php echo $c_code_ar ?> <?php echo $arabic ?></span></h3> -->
<h3 class="widget-title">
  ...
  <ul class="product_list_widget">
	<?php if($countrylatest2){
		...
		$data = $rt->prepare( [$rt->getDetails($countrylatest2[0]->id)] );
		?>
			<li>
