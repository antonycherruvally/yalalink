...
<head>
<meta charset="utf-8">
<meta name="viewport" content="maximum-scale=1, width=device-width, initial-scale=1, shrink-to-fit=no">
  ...
  <div class="full-wrap header-top">
    <div class="container">
      <ul class="country-sec">
        <li class="<?php if($country_code=='AE') echo 'current-country'; ?>"><a href="set_country/AE" class="bounce-ani map-ico uae-flag" data-toggle="tooltip" data-placement="bottom" title="UAE"></a></li>
        <li class="<?php if($country_code=='OM') echo 'current-country'; ?>"><a href="set_country/OM" class="bounce-ani map-ico oman-flag"  data-toggle="tooltip" data-placement="bottom" title="Oman"></a></li>
        <li class="<?php if($country_code=='SA') echo 'current-country'; ?>"><a href="set_country/SA" class="bounce-ani map-ico saudi-flag"  data-toggle="tooltip" data-placement="bottom" title="Saudi Arabia"></a></li>
        <li class="<?php if($country_code=='KW') echo 'current-country'; ?>"><a href="set_country/KW" class="bounce-ani map-ico kuwait-flag"  data-toggle="tooltip" data-placement="bottom" title="Kuwait"></a></li>
        <li class="<?php if($country_code=='BH') echo 'current-country'; ?>"><a href="set_country/BH" class="bounce-ani map-ico bahrain-flag"  data-toggle="tooltip" data-placement="bottom" title="Bahrain"></a></li>
      </ul>
  ...
  <div class="mobile-header sticky-top-shadow">
        ...
        <div class="hero-bg-img mobile-logo"><a href="index" class="full-click"></a></div>
          ...
          <div class="mobile-search">
            ...
            <div class="post-add-forall">
                <div class="sidebar-ad"> <a href="post-an-ad" class="hero-button btn-place-ad add-forall-btn"> 
                 <span class="ar-txt add-ar pull-right">أضف إعلانك مجانا</span> <span class="pull-left">post free add</span></a> </div>
            </div>
        </div>
    </div>
    <!-- Mobile Menu Navigation -->  
...
<div class="full-wrap detail-page listing-master-wrap detailpage-wrap">
