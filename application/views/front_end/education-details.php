                ...
                <div class="container">
                    ...
                    <nav class="woocommerce-breadcrumb">
                      ...
                      <a href="education">Education</a>
                        <span class="delimiter"><i class="fa fa-angle-right"></i></span>
                       <a href="education?type=<?php echo $view->type; ?>"><?php echo $view->type; ?></a>
...
<?php if($view->mobile){ ?>
<a href="javascript:void(0);" class="hero-button btn-shadow icon-btn call-show-nmb detail-btn btn-FF9800 realsub" x="<?php echo @$view->mobile; ?>"><span class="show-number"><i class="fa fa-phone bounce-ani" aria-hidden="true" ></i>Call</span></a> 
<?php } ?>
<?php if($view->email){ ?>
