                    ...
                    <div id="primary" class="content-area">
                        ...
                        <main id="main" class="site-main">
                            ...
                            <div class="shop-control-bar">
                                <ul class="shop-view-switcher nav nav-tabs types" role="tablist">
                                ...
                                <!--<form class="woocommerce-ordering" method="get">-->
                                    ...
                                    <ul class="shop-view-switcher nav nav-tabs tabtypes" role="tablist">
                                       <li class="typestab" ><a class="nav-link link-radius1 <?php if($this->input->get('type')=='Used' || $this->input->get('type')==''){ echo 'active'; } ?>" data-toggle="tab" id="used" href="javascript:void(0);" role="tab">Rent</a> </li>
                                       <li class="typestab1"><a class="nav-link link-radius1<?php if($this->input->get('type')=='New' && $this->input->get('type')!='New'){ echo 'active'; } ?>" data-toggle="tab" id="new" href="javascript:void(0);" role="tab">Buy</a></li>
                                        </ul>
                        ...
                        <aside class="widget woocommerce widget_product_categories electro_widget_product_categories">
                            <ul class="product-categories category-single">
                                <li class="product_cat">
                                    ...
                                    <ul>
                                        <li class="cat-item current-cat"><a href="<?=Core::getBaseUrl()?>real-estate">Real Estate</a> <span class="count"></span>
                                            <ul class='children'>
                                                <li class="nav-item"> <a class="nav-link <?php if($this->input->get('property-type')==8){ echo 'active'; }elseif($this->input->get('property-type')==''){ echo 'active'; } ?> category" data-toggle="tab" id="8" href="#villas" role="tab">Villas & Lands</a> </li>
      <li class="nav-item"> <a class="nav-link <?php if($this->input->get('property-type')==4){ echo 'active'; } ?> category" data-toggle="tab" id="4" href="#appartments" role="tab">Appartments</a> </li>
      <li class="nav-item"> <a class="nav-link <?php if($this->input->get('property-type')==5){ echo 'active'; } ?> category" data-toggle="tab" id="5" href="#commercial" role="tab">Commercial Realestate</a> </li>
                       ...
                       <!-- <aside class="widget widget_electro_products_filter">
                        ...
                        <aside class="widget widget_text">
                            <div class="textwidget">
                                <a href="#"><img src="assets/images/sp1.jpg" alt="Banner"></a>
                            </div>
                        </aside>
...
$(document).ready(function(e) {
	...
	$(document).on('click','.unfavorites',function(e){
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>real_estate/getListingslist?type='+type+'&category='+category+'&subcategory='+subcategory+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>real_estate/getListingslistsmall?type='+type+'&category='+'893'+'&subcategory='+subcategory+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
