    ...
    <div class="row" style="margin-top: 50px;border: 1px solid #4fc3c533;margin-bottom: 15px;padding: 18px;">
      ...
      <div class="col-md-12">
        <div class="post-ad-wrap">
            ...
            <h3 style="color:black;">Posting Your Services Ad </h3>
           
              <form class="m-t-15" action="insertServices" enctype="multipart/form-data" method="post" name="post-form" id="post-form">
                  ...
                  <div class="col-md-12">
                    <label class="form-check-label mat-label-color" for="type">Choose Type:</label>
                      ...
                      <label class="radio-inline">
                        <input type="radio" name="type" id="type_1" value="Maintenance">
                        Maintenance </label>
                      <label class="radio-inline">
                        <input type="radio" name="type" id="type_2" value="Services" checked>
                        Services </label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="card-header" style="direction:none !important">&nbsp;</div>
                    <div class="form-group select-box-search bmd-form-group mat-select">
