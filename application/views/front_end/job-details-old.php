  ...
  <div class="full-wrap store-detail-wrap mob-margin-cmn">
    <div class="row node-breadcrumb text-muted">
      <ol class="breadcrumb">
        ...
        <li><a href="jobs?type=Hiring">Job Offers</a></li>
        <li class="active">Job ref no: <?php echo $view->ref_no; ?></li>
    ...
    <div class="personal-detail job-offers">
      <figure class="img-box-detail"><img src="<?php echo $img; ?>"> </figure>
      <div class="inline-block job-details-card">
        <h2 class="store-head"><?php echo $view->title_en.'<br>'.$view->title_ar; ?></h2>
        <h4 class="inline-block pos location"><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo $area.$location.$country; ?></h4>
      </div>
    </div>
    <div class="full-wrap store-detail-box-wrap">
      <div class="col-md-4 store-detail-box inline-block hero-radius">
        <div class="head">
          <figure><i class="fa fa-black-tie" aria-hidden="true"></i></figure>
          <i>Highlights</i></div>
        <ul class="list-inline row gnralbox amentity-box-wrap">
          <li class="amentity-box inline-block">
            <p> <span><i class="show_color"><?php echo $view->salary; ?></i></span> </p>
          </li>
          <li class="amentity-box inline-block">
      ...
      <div class="col-md-8 store-detail-box inline-block hero-radius">
        <div class="head">
        ...
        <ul class="list-inline row gnralbox">
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              ...
              <span><i class="show_color"><?php echo $industry->title; ?></i></span> </p>
          </li>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label>Position:</label>
              <span><i class="show_color"><?php echo $position->title; ?></i></span> </p>
          </li>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label>Level:</label>
              <span><i class="show_color"><?php echo $view->level; ?></i></span> </p>
          </li>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label>Type:</label>
              <span><i class="show_color"><?php echo $view->job_type; ?></i></span> </p>
          </li>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label>Qualification:</label>
              <span><i class="show_color"><?php echo $view->qualification; ?></i></span> </p>
          </li>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label>Gender:</label>
          ...
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              ...
              <span><i class="show_color"><?php if($nationality) echo $nationality->name; ?></i></span> </p>
          </li>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label>Salary:</label>
