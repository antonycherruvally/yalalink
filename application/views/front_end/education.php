...
<div class="ultypes" style="display:none;">
          <li class="nav-item"> <a class="nav-link <?php if($this->input->get('type')=='Universities'){ echo 'active'; }elseif($this->input->get('type')==''){ echo 'active'; } ?> type" id="Universities" data-toggle="tab" href="#new" role="tab">Universities & Schools</a> </li>
    <li class="nav-item"> <a class="nav-link link-radius <?php if($this->input->get('type')=='Institutes'){ echo 'active'; } ?> type" id="Institutes" data-toggle="tab" href="#used" role="tab"> Institutes & Training</a> </li>
  </ul>
  <input type="hidden" value="<?php if($this->input->get('type')){ echo $this->input->get('type'); }else{ echo 'Universities'; }?>" name="type" id="type">
  <input type="hidden" value="<?php if($this->input->get('category')){ echo $this->input->get('category'); }?>" name="category" id="category">
   ...
   <div class="tab-content">
            ...
            <?php } } ?>
                                    ...
                                    <ul>
                                        <li class="cat-item current-cat"><a href="product-category.html">Education</a> <span class="count"></span>
                                            <ul class='children'>
                                                <li class="nav-item"> <a class="nav-link  <?php if($this->input->get('type')=='Universities'){ echo 'active'; }elseif($this->input->get('type')==''){ echo 'active'; } ?> type" id="Universities" data-toggle="tab" href="#new" role="tab">Universities & Schools</a> </li>
      											<li class="nav-item"> <a class="nav-link<?php if($this->input->get('type')=='Institutes'){ echo 'active'; } ?> type" id="Institutes" data-toggle="tab" href="#used" role="tab"> Institutes & Training</a> </li>
...
$(document).ready(function(e) {
	...
	$(document).on('click','.unfavorites',function(e){
        ...
        $.ajax({
            'url': '<?php echo base_url(); ?>education/getListings?type='+type+'&category='+category+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>education/getListingslist?type='+type+'&category='+category+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>education/getListingslistsmall?type='+type+'&category='+category+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
