...
<div class="ultypes" style="display:none;">
    ...
    <li class="nav-item"> <a class="nav-link link-radius <?php if($this->input->get('type')=='Hiring'){ echo 'active'; }elseif($this->input->get('type')==''){ echo 'active'; } ?> category" data-toggle="tab" id="Hiring" href="#hiring" role="tab">Job Offers</a> </li>
    <li class="nav-item"> <a class="nav-link category <?php if($this->input->get('type')=='Looking'){ echo 'active'; } ?>" data-toggle="tab" href="#looking" id="Looking" role="tab">Talents Available</a> </li>
  </ul>
  
  <input type="hidden" value="<?php if($this->input->get('type')){ echo $this->input->get('type'); }else{ echo 'Hiring'; }?>" name="type" id="type">
</div>
            ...
            <?php } } ?>
                                    ...
                                    <ul>
                                        <li class="cat-item current-cat"><a href="<?=Core::getBaseUrl()?>jobs">Jobs</a> <span class="count"></span>
                                            <ul class='children'>
                                                <li class="nav-item"> <a class="nav-link <?php if($this->input->get('type')=='Hiring'){ echo 'active'; }elseif($this->input->get('type')==''){ echo 'active'; } ?> category" data-toggle="tab" id="Hiring" href="#hiring" role="tab">Job Offers</a> </li>
                                                <li class="nav-item"> <a class="nav-link  <?php if($this->input->get('type')=='Looking'){ echo 'active'; } ?>" data-toggle="tab" href="#looking" id="Looking" role="tab">Talents Available</a> </li>
...
$(document).ready(function(e) {
	...
	$(document).on('click','.unfavorites',function(e){
        ...
        $.ajax({
            'url': '<?php echo base_url(); ?>jobs/getListings?type='+type+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>jobs/getListingslistsmall?type='+type+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>jobs/getListingslist?type='+type+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
