    ...
    <div class="row">
      <div class="col-md-12">
        <div class="post-ad-wrap">
          <div class="card">
            <div class="card-header">Posting Your Real Estate Ad </div>
              ...
              <form class="m-t-15" action="insertRealestate" enctype="multipart/form-data" method="post" name="post-form" id="post-form">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" class="js-example-basic-single no-border mat-txt mat-font first-txt" name="title_en" id="title_en">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group bmd-form-group">
                      <label for="title_ar" class="bmd-label-floating">Title in Arabic:</label>
                      <input type="text" class="js-example-basic-single no-border mat-txt mat-font first-txt" style="direction:rtl;" name="title_ar" id="title_ar">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="js-example-basic-single" name="purpose" id="purpose">
                  ...
                  <div class="col-md-3">
                    <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="js-example-basic-single" name="property_type" id="property_type">
                  ...
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" class="js-example-basic-single no-border mat-txt mat-font first-txt" id="price" name="price">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group select-box-search bmd-form-group mat-select">
                      <label for="price_per" class="bmd-label-floating mat-label-color">Price Per Year/Month:</label>
                      <select class="js-example-basic-single" name="price_per" id="price_per">
                ...
                <div class="row">
                  <div class="col-md-3 residential">
                    <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="js-example-basic-single" name="bedroom" id="bedroom">
                  ...
                  <div class="col-md-3 residential">
                    <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="js-example-basic-single" name="bathroom" id="bathroom">
                  ...
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" class="js-example-basic-single no-border mat-txt mat-font first-txt" id="size" name="size">
                    </div>
                  </div>
                </div>
                 <div class="row">
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" class="js-example-basic-single no-border mat-txt mat-font first-txt" id="contact" name="contact">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      <label for="size" class="bmd-label-floating">Email:</label>
                      <input type="text" class="js-example-basic-single no-border mat-txt mat-font first-txt" id="email" name="email">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-3">
                    ...
                    <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="js-example-basic-single" name="country" id="country"<?php /*?> onchange="changeMap(this.value)"<?php */?>>
                    ...
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" class="js-example-basic-single no-border mat-txt mat-font first-txt" id="latitude" name="latitude">
                    </div>
                  </div>
                  <div class="col-md-3">
                    ...
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" class="js-example-basic-single no-border mat-txt mat-font first-txt" id="longitude" name="longitude">
                    </div>
                  </div>
                  <div class="col-md-6">
                    ...
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" class="js-example-basic-single no-border mat-txt mat-font first-txt" id="address" name="address" autocomplete="off">
                    </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <textarea type="text" id="description" name="description" class="js-example-basic-single md-textarea  mat-txt" rows="3" placeholder="Description"></textarea>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group input-group">
                      ...
                      <label class="btn btn-raised hero-radius btn-644e97 mat-submit"> <i class="fa fa-camera" aria-hidden="true" style="font-size: 20px;">&nbsp;</i> Add Images&hellip;
                        <input type="file" class="ngo_proof_attach_input_file js-example-basic-single image-upload" name="image[]" id="image" accept="image/png, image/jpeg, image/jpg" data-fv-file-type="image/png, image/jpeg, image/jpg" multiple required="" style="display: none;" max="10" />
                      </label>
                      <input type="text" class="js-example-basic-single text-count" readonly style="height:40px;">
                      <br>
