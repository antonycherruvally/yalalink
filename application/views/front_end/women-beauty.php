...
<div class="ultypes" style="display:none;">
    ...
    <li class="nav-item"> <a class="nav-link <?php if($this->input->get('type')=='Women'){ echo 'active'; }elseif($this->input->get('type')==''){ echo 'active'; } ?> type" id="Women" data-toggle="tab" href="#women" role="tab"> Women</a> </li>
    <li class="nav-item"> <a class="nav-link link-radius <?php if($this->input->get('type')=='Beauty'){ echo 'active'; } ?> type" id="Beauty" data-toggle="tab" href="#beauty" role="tab"> Beauty</a> </li>
  </ul>
  <input type="hidden" value="<?php if($this->input->get('type')){ echo $this->input->get('type'); }else{ echo 'Women'; }?>" name="type" id="type">
</div>
   ...
   <div class="tab-content">
            ...
            <?php } } ?>
                                    ...
                                    <ul>
                                        <li class="cat-item current-cat"><a href="product-category.html">Women & Beauty</a> </span>
                                            <ul class='children'>
                                                <li class="nav-item"> <a class="nav-link <?php if($this->input->get('type')=='Women'){ echo 'active'; }elseif($this->input->get('type')==''){ echo 'active'; } ?> type" id="Women" data-toggle="tab" href="#women" role="tab"> Women</a> </li>
      <li class="nav-item"> <a class="nav-link  <?php if($this->input->get('type')=='Beauty'){ echo 'active'; } ?> type" id="Beauty" data-toggle="tab" href="#beauty" role="tab"> Beauty</a> </li>
...
$(document).ready(function(e) {
	...
	$(document).on('click','.unfavorites',function(e){
        ...
        $.ajax({
            'url': '<?php echo base_url(); ?>women-beauty/getListings?type='+type+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>women-beauty/getListingslist?type='+type+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>women-beauty/getListingslistsmall?type='+type+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
	...
	$('.type').click(function(e) {
		...
		$('.result-div').hide();
        $.ajax({
            'url': '<?php echo base_url(); ?>women-beauty/getListings?type='+type,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
