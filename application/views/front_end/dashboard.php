  ...
  <div class="row">
    <div class="col-md-12">
      <div class="post-ad-wrap dashboard-hero">
        <div class="card card-dashboard" style="border: 1px solid #662d91 !important;
    box-shadow: none;">
                ...
                <div class="row mobile-row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="tab-content" id="pills-tabContent">
                      <div class="tab-pane fade active" id="v-pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        ...
                        <form action="updateprofile" enctype="multipart/form-data" method="post" id="update-form">
                          ...
                          <div class="form-row">
                            <div class="form-group col-md-12 is-filled is-focused">
                              ...
                              <input type="text" class="form-control no-border mat-txt" name="first_name" id="first_name" value="<?php echo $user->first_name; ?>" style="border-bottom: 1px solid;padding-top: 32px;">
                            </div>
                            <div class="form-group col-md-12 is-filled is-focused">
                              <label for="inputEmail4">Last Name:</label>
                              <input type="text" class="form-control no-border mat-txt" name="last_name" id="last_name" value="<?php echo $user->last_name; ?>" style="border-bottom: 1px solid;padding-top: 32px;">
                            </div>
                            <div class="form-group col-md-12 is-filled is-focused">
                              <label for="inputEmail4">Company Name:</label>
                              <input type="text" class="form-control no-border mat-txt" name="company" id="company" value="<?php echo $user->company_name; ?>" placeholder="www.campany.com" style="border-bottom: 1px solid;padding-top: 32px;">
                            </div>
                            <div class="form-group col-md-12 is-filled is-focused">
                              <label for="inputEmail4">Website URL:</label>
                              <input type="text" class="form-control no-border mat-txt" name="website" id="website" value="<?php echo $user->website; ?>" style="border-bottom: 1px solid;padding-top: 32px;">
                            </div>
                            <div class="form-group col-md-12 is-filled is-focused">
                              ...
                              <input type="text" class="form-control no-border mat-txt" name="mobile" id="mobile" value="<?php echo $user->area_code.$user->mobile; ?>" style="border-bottom: 1px solid;padding-top: 32px;">
