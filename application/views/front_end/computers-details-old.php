  ...
  <div class="full-wrap store-detail-wrap">
    <div class="row node-breadcrumb text-muted">
      <ol class="breadcrumb">
        ...
        <li><a href="computers?category=<?php echo $view->category; ?>&type=<?php echo $view->type; ?>"><?php echo $view->cat; ?></a></li>
        <li><a href="computers?category=<?php echo $view->category; ?>&type=<?php echo $view->type; ?>"><?php echo $view->subcat; ?></a></li>
      ...
      <div class="col-md-6 store-detail-box inline-block hero-radius">
        ...
        <?php if($view->model){ ?>
           <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label>Model:</label>
              <span><i class="show_color"><?php echo @$view->model; ?></i></span> </p>
          </li>
          <?php } ?>
        <?php if($view->age){ ?>
           <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
        ...
        <?php if($view->condition){ ?>
           <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              ...
              <span><i class="show_color"><?php echo @$view->condition; ?></i></span> </p>
          </li>
          <?php } ?>
        ...
        <?php if($view->memory){ ?>
           <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label>Memory:</label>
              <span><i class="show_color"><?php echo @$view->memory; ?></i></span> </p>
          </li>
          <?php } ?>
        <?php if($view->processor){ ?>
           <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              ...
              <span><i class="show_color"><?php echo @$view->processor; ?></i></span> </p>
          </li>
          <?php } ?>
        <?php if($view->graphics){ ?>
           <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              ...
              <span><i class="show_color"><?php echo @$view->graphics; ?></i></span> </p>
          </li>
          <?php } ?>
        <?php if($view->operating_system){ ?>
           <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              ...
              <span><i class="show_color"><?php echo @$view->operating_system; ?></i></span> </p>
          </li>
          <?php } ?>
