...
<?php $this->load->view('blocks/electfilter.php');?>
   ...
   <div class="tab-content">
            ...
            <?php } } ?>
                                    ...
                                    <ul>
                                        <li class="cat-item current-cat"><a href="product-category.html">Electronics</a> <span class="count"></span>
                                            <ul class='children'>
                                                <li class="nav-item"> <a class="nav-link  <?php if($this->input->get('type')=='Used'){ echo 'active'; }elseif($this->input->get('type')==''){ echo 'active'; } ?> type" id="Used" data-toggle="tab" href="#used" role="tab">Air Conditioners & Coolers</a> </li>
      											<li class="nav-item"> <a class="nav-link<?php if($this->input->get('type')=='New'){ echo 'active'; } ?> type" id="New" data-toggle="tab" href="#new" role="tab">Audio Accessories</a> </li>
                                                  <li class="nav-item"> <a class="nav-link<?php if($this->input->get('type')=='New'){ echo 'active'; } ?> type" id="New" data-toggle="tab" href="#new" role="tab">Camera & Camcorder Accessories</a> </li>
                                                  <li class="nav-item"> <a class="nav-link<?php if($this->input->get('type')=='New'){ echo 'active'; } ?> type" id="New" data-toggle="tab" href="#new" role="tab">Home Theater Systems</a> </li>
                                                  <li class="nav-item"> <a class="nav-link<?php if($this->input->get('type')=='New'){ echo 'active'; } ?> type" id="New" data-toggle="tab" href="#new" role="tab">Televisions</a> </li>
                                                  <li class="nav-item"> <a class="nav-link<?php if($this->input->get('type')=='New'){ echo 'active'; } ?> type" id="New" data-toggle="tab" href="#new" role="tab">Washing Machines</a> </li>
...
$(document).ready(function(e) {
	...
	$(document).on('click','.unfavorites',function(e){
        ...
        $.ajax({
            'url': '<?php echo base_url(); ?>electronics/getListings?type='+type+'&category='+category+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>electronics/getListingslistsmall?type='+type+'&category='+category+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>electronics/getListingslist?type='+type+'&category='+category+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
