  ...
  <div class="full-wrap store-detail-wrap">
    <div class="row node-breadcrumb text-muted">
      <ol class="breadcrumb">
        ...
        <li><a href="electronics?category=<?php echo $view->category; ?>&type=<?php echo $view->type; ?>"><?php echo $view->cat; ?></a></li>
        <li><a href="electronics?category=<?php echo $view->category; ?>&type=<?php echo $view->type; ?>"><?php echo $view->type; ?></a></li>
        ...
        <?php if($view->weight){ ?>
          ...
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              ...
              <span><i class="show_color"><?php echo @$view->display_type; ?></i></span> </p>
          </li>
          <?php } ?>
          <?php if($view->weight){ ?>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label>TV Type:</label>
              <span><i class="show_color"><?php echo @$view->category_type; ?></i></span> </p>
          </li>
          <?php } ?>
          <?php if($view->color){ ?>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
          ...
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              ...
              <span><i class="show_color"><?php echo @$view->dimension; ?></i></span> </p>
          </li>
          <?php } ?>
          ...
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              ...
              <span><i class="show_color"><?php echo @$view->megapixel; ?></i></span> </p>
          </li>
          <?php } ?>
          ...
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              ...
              <span><i class="show_color"><?php echo @$view->power_source; ?></i></span> </p>
          </li>
          <?php } ?>
          ...
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              ...
              <span><i class="show_color"><?php echo @$view->connectivity; ?></i></span> </p>
          </li>
          <?php } ?>
        </ul>
      </div>
      ...
      <div class="col-md-6 store-detail-box inline-block hero-radius">
        ...
        <?php if($view->brand){ ?>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label>Brand:</label>
              <span><i class="show_color"><?php echo @$view->brand; ?></i></span> </p>
          </li>
          <?php } ?>
          <?php if($view->storage){ ?>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label>Storage:</label>
              <span><i class="show_color"><?php echo @$view->storage; ?></i></span> </p>
          </li>
          <?php } ?>
          ...
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              ...
              <span><i class="show_color"><?php echo @$view->optical_zoom; ?></i></span> </p>
          </li>
          <?php } ?>
          <?php if($view->style){ ?>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label>Style:</label>
              <span><i class="show_color"><?php echo @$view->style; ?></i></span> </p>
          </li>
          <?php } ?>
          ...
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              ...
              <span><i class="show_color"><?php echo @$view->material; ?></i></span> </p>
          </li>
          <?php } ?>
          ...
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              ...
              <span><i class="show_color"><?php echo @$view->compatible; ?></i></span> </p>
          </li>
          <?php } ?>
          <?php if($view->player){ ?>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label>Player:</label>
              <span><i class="show_color"><?php echo @$view->player; ?></i></span> </p>
          </li>
          <?php } ?>
			<?php if($view->mobile){ ?>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
    ...
    <!--<div class="detail-btn-wrap pos-center one-btn-wrap"> <a href="" class="hero-button btn-shadow icon-btn detail-btn btn-FF9800"> <span><img src="assets/front_end/images/cart-icon.png" class="cart-ico bounce-ani">&nbsp;Add To Cart</span> </a> </div>-->
