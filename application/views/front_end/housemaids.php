  ...
  <input type="hidden" value="<?php if($this->input->get('type')){ echo $this->input->get('type'); }else{ echo 'Domestic'; }?>" name="type" id="type">
   ...
   <div class="tab-content">
            ...
            <?php } } ?>
                                    ...
                                    <ul>
                                        <li class="cat-item current-cat"><a href="product-category.html">House Maids</a> </span>
                                            <ul class='children'>
                                                <li class="nav-item"> <a class="nav-link <?php if($this->input->get('type')=='Domestic'){ echo 'active'; }elseif($this->input->get('type')==''){ echo 'active'; } ?> category" id="Domestic" data-toggle="tab" href="#domestic" role="tab">Domestic</a> </li>
      <li class="nav-item"> <a class="nav-link  <?php if($this->input->get('type')=='Abroad'){ echo 'active'; } ?> category" id="Abroad" data-toggle="tab" href="#abroad" role="tab">Abroad</a> </li>
...
$(document).ready(function(e) {
	...
	$(document).on('click','.unfavorites',function(e){
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>housemaids/getListingslist?type='+type+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
		...
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>housemaids/getListingslistsmall?type='+type+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
