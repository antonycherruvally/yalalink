				...
				<div class="container">
					...
					<nav class="woocommerce-breadcrumb">
					  ...
					  <a href="services">Services</a>
						<span class="delimiter"><i class="fa fa-angle-right"></i></span>
					  <a href="services?category=<?php if(isset($view->category)) echo $view->category; ?>&type=<?php echo $view->type; ?>"><?php echo $view->cat; ?></a>
...
<a href="tel:<?php echo @$view->mobile; ?>"><span class="hero-button btn-shadow icon-btn call-show-nmb detail-btn btn-FF9800 realsub nummob" style="display:none;">Call<i class="fa fa-phone bounce-ani" aria-hidden="true" ></i></span></a> 
<?php } ?>
<?php if($view->email){ ?>
 ...
 <aside class="widget widget_text mobgoogleadview">
        ...
        <script>
            (adsbygoogle = window.adsbygoogle || []).push({});
                            ...
                            <?php $this->load->view('blocks/slider/similarads', ['category' => 'Services']); ?>
                               <?php $this->load->view('blocks/slider/ualsolike',['category' => 'Services']);?>
                        </div>
                </div><!-- /.container -->
