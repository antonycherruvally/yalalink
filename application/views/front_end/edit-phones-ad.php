    ...
    <div class="row"  style="margin-top: 50px;border: 1px solid #4fc3c533;margin-bottom: 15px;padding: 18px;">
      ...
      <div class="col-md-12">
        <div class="post-ad-wrap">
             ...
             <h3 style="color:black;">Update Your Phones Ad </h3>
           
              <form class="m-t-15" action="updatePhones" enctype="multipart/form-data" method="post" name="post-form" id="post-form">
                  ...
                  <div class="col-md-3">
                    <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="form-control" name="brand" id="brand">
						...
						if($brand){ foreach($brand as $val){$selected = '';
              if($details->brand == $val->id){
                $selected = 'selected';
              }?>
                  ...
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" value="<?php echo $details->model; ?>" class="form-control no-border mat-txt mat-font first-txt" name="model" id="model">
                    </div>
                  </div>
...
foreach ($storage as $val) { $selected = '';
...
foreach ($operating_system as $val) { $selected = '';
              if($details->operating_system == $val){
                $selected = 'selected';
              }?>
                        <option value="<?php echo $val; ?>" <?php echo $selected; ?>><?php echo $val; ?></option>
                        <?php } ?>
...
foreach ($camera_resolution as $val) { $selected = '';
              if($details->camera_resolution == $val){
                $selected = 'selected';
              }?>
                        <option value="<?php echo $val; ?>" <?php echo $selected; ?>><?php echo $val; ?></option>
                        <?php } ?>
...
foreach ($capacity as $val) { $selected = '';
              if($details->capacity == $val){
                $selected = 'selected';
              }?>
                        <option value="<?php echo $val; ?>" <?php echo $selected; ?>><?php echo $val; ?></option>
                        <?php } ?>
                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" value="<?php echo $details->dimensions; ?>" class="form-control no-border mat-txt mat-font first-txt" name="dimensions" id="dimensions">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      <label for="weight" class="bmd-label-floating">Weight (g):</label>
                      <input type="text" value="<?php echo $details->weight; ?>" class="form-control no-border mat-txt mat-font first-txt" name="weight" id="weight">
                    </div>
                  </div>
                  <div class="col-md-3">
                      <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="form-control" name="removable_battery" id="removable_battery">
                        ...
                        <option value="Yes" <?php if($details->removable_battery == 'Yes'){ echo 'selected'; } ?>>Yes</option>
                        <option value="No" <?php if($details->removable_battery == 'No'){ echo 'selected'; } ?>>No</option>
                      </select>
                    </div>
                    </div>
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" value="<?php echo $details->screen_size; ?>" class="form-control no-border mat-txt mat-font first-txt" name="screen_size" id="screen_size">
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="form-control" name="touchscreen" id="touchscreen">
                        ...
                        <option value="Yes" <?php if($details->touchscreen == 'Yes'){ echo 'selected'; } ?>>Yes</option>
                        <option value="No" <?php if($details->touchscreen == 'No'){ echo 'selected'; } ?>>No</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" value="<?php echo $details->resolution; ?>" class="form-control no-border mat-txt mat-font first-txt" name="resolution" id="resolution">
                    </div>
                  </div>
                  <div class="col-md-3">
                  <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="form-control" name="compass" id="compass">
                        ...
                        <option value="Yes" <?php if($details->compass == 'Yes'){ echo 'selected'; } ?>>Yes</option>
                        <option value="No" <?php if($details->compass == 'No'){ echo 'selected'; } ?>>No</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-3">
                  <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="form-control" name="proximity" id="proximity">
                        ...
                        <option value="Yes" <?php if($details->proximity == 'Yes'){ echo 'selected'; } ?>>Yes</option>
                        <option value="No" <?php if($details->proximity == 'No'){ echo 'selected'; } ?>>No</option>
                      </select>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="form-control" name="accelerometer" id="accelerometer">
                        ...
                        <option value="Yes" <?php if($details->accelerometer == 'Yes'){ echo 'selected'; } ?>>Yes</option>
                        <option value="No" <?php if($details->accelerometer == 'No'){ echo 'selected'; } ?>>No</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-3">
                  <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="form-control" name="light" id="light">
                        <option value="">Select Accelerometer</option>
                        <option value="Yes" <?php if($details->light == 'Yes'){ echo 'selected'; } ?>>Yes</option>
                        <option value="No" <?php if($details->light == 'No'){ echo 'selected'; } ?>>No</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-3">
                  <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="form-control" name="gyroscope" id="gyroscope">
                        ...
                        <option value="Yes" <?php if($details->gyroscope == 'Yes'){ echo 'selected'; } ?>>Yes</option>
                        <option value="No" <?php if($details->gyroscope == 'No'){ echo 'selected'; } ?>>No</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-3">
                  <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="form-control" name="barometer" id="barometer">
                        ...
                        <option value="Yes" <?php if($details->barometer == 'Yes'){ echo 'selected'; } ?>>Yes</option>
                        <option value="No" <?php if($details->barometer == 'No'){ echo 'selected'; } ?>>No</option>
                      </select>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="form-control" name="temperature" id="temperature">
                        ...
                        <option value="Yes" <?php if($details->temperature == 'Yes'){ echo 'selected'; } ?>>Yes</option>
                        <option value="No" <?php if($details->temperature == 'No'){ echo 'selected'; } ?>>No</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" value="<?php echo $details->form_factor; ?>" class="form-control no-border mat-txt mat-font first-txt" name="form_factor" id="form_factor">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group select-box-search bmd-form-group mat-select">
