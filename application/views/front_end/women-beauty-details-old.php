  ...
  <div class="full-wrap store-detail-wrap">
    <div class="row node-breadcrumb text-muted">
      <ol class="breadcrumb">
        ...
        <li><a href="woman-beauty">Woman & Beauty</a></li>
        <li><a href="woman-beauty?type=<?php echo $view->type; ?>"><?php echo $view->type; ?></a></li>
      </ol>
    </div>
      ...
      <div class="col-md-12 store-detail-box inline-block hero-radius">
        ...
        <ul class="list-inline row gnralbox">
          ...
          <li class="col-xs-12 col-sm-12 col-md-12 inline-block">
            <p>
              <label><img src="assets/front_end/images/grid-world.png"></label>
              <span><i class="show_color"><?php echo @$view->w_email; ?></i></span> </p>
          </li>
          <li class="col-xs-12 col-sm-12 col-md-12 inline-block">
            <p>
