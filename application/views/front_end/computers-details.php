...
<?php } ?>
 <div id="content" class="site-content" tabindex="-1">
				<div class="container">
					...
					<nav class="woocommerce-breadcrumb">
					   ...
					   <a href="computers">Computers</a>
						<span class="delimiter"><i class="fa fa-angle-right"></i></span>
					   <a href="computers?category=<?php echo $view->category; ?>&type=<?php echo $view->type; ?>"><?php echo $view->cat; ?></a>
					   <span class="delimiter"><i class="fa fa-angle-right"></i></span>
						<a href="computers?category=<?php echo $view->category; ?>&type=<?php echo $view->type; ?>"><?php echo $view->subcat; ?></a>                    </nav><!-- /.woocommerce-breadcrumb -->
  ...
  <div class="carousel slide" id="cat-slider" data-ride="carousel"> 
	<!-- Carousel items -->
	<div class="carousel-inner hero-radius  mobidetailsviewcomp">
	  <?php  if($images){ $i = 0;
	  ...
	  <ul class="hide-bullets store-bullets">
	   <?php  if($images){ $i = 0; foreach($images as $val){
								...
								<div class="woocommerce-tabs wc-tabs-wrapper">
									<ul class="nav nav-tabs electro-nav-tabs tabs wc-tabs" role="tablist">
										<li class="nav-item accessories_tab">
											<a href="#tab-accessories" class="active" data-toggle="tab">General</a>
										</li>
		...
		<?php if($view->memory){ ?>
		   <tr>
		   <td>Memory:</td>
			  <td><?php echo @$view->memory; ?></td>
		  </tr>
		  <?php } ?>
		<?php if($view->processor){ ?>
		   <tr>
		   <td>Processor:</td>
			  <td><?php echo @$view->processor; ?></td>
		  </tr>
		  <?php } ?>
		<?php if($view->graphics){ ?>
		   <tr>
		   <td>Graphics:</td>
			  <td><?php echo @$view->graphics; ?></td>
		  </tr>
		  <?php } ?>
		<?php if($view->operating_system){ ?>
			<tr>
		   <td>Operating System:</td>
			  <td><?php echo @$view->operating_system; ?></td>
		  </tr>
		  <?php } ?>
...
<?php } ?>
    ...
    <script>
      (adsbygoogle = window.adsbygoogle || []).push({});
                            ...
                            <?php $this->load->view('blocks/slider/similarads', ['category' => 'Computers']); ?>
                               <?php $this->load->view('blocks/slider/ualsolike',['category' => 'Computers']);?>
                        </div>
                </div><!-- /.container -->
