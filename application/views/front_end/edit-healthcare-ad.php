    ...
    <div class="row"  style="margin-top: 50px;border: 1px solid #4fc3c533;margin-bottom: 15px;padding: 18px;">
      <div class="col-md-12">
        <div class="post-ad-wrap">
            ...
            <h3 style="color:black;">Update Your Health Care Ad </h3>
         
              <form class="m-t-15" action="updateHealthcare" enctype="multipart/form-data" method="post" name="post-form" id="post-form">
                  ...
                  <div class="col-md-12">
                    <label class="form-check-label mat-label-color" for="type">Choose Type:</label>
                      ...
                      <label class="radio-inline">
                        <input type="radio" name="type" id="type_1" value="Hospitals" <?php if($edit->type == 'Hospitals'){ echo 'checked'; }?>>
                        Hospitals </label>
                      <label class="radio-inline">
                        <input type="radio" name="type" id="type_2" value="Clinics"  <?php if($edit->type == 'Clinics'){ echo 'checked'; }?>>
                        Clinics </label>
						<label class="radio-inline">
                        <input type="radio" name="type" id="type_3" value="Dental Hospitals"  <?php if($edit->type == 'Dental Hospitals'){ echo 'checked'; }?>>
                        Dental Hospitals </label>
						<label class="radio-inline">
                        <input type="radio" name="type" id="type_4" value="Dentist"  <?php if($edit->type == 'Dentist'){ echo 'checked'; }?>>
                        Dentist </label>
