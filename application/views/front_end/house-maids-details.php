 ...
 <div id="content" class="site-content" tabindex="-1">
                <div class="container">
                    ...
                    <nav class="woocommerce-breadcrumb">
                        ...
                        <a href="housemaids">House Maids</a>
                        <span class="delimiter"><i class="fa fa-angle-right"></i></span>
                       <a href="housemaids?type=<?php echo $view->type; ?>"><?php echo $view->type; ?></a>
...
-->
                                    ...
                                    <ul class="nav nav-tabs electro-nav-tabs tabs wc-tabs" role="tablist">
                                      <!--  <li class="nav-item accessories_tab">
                                        ...
                                        <li class="nav-item description_tab">
                                            <a href="#tab-description" class="active" data-toggle="tab">Personal Details</a>
                                        </li>
          ...
          <tr><td>Age:</td>
              <td><?php echo @$view->age; ?></td></tr>
          <tr><td>Gender:</td>
              <td><?php echo @$view->gender; ?></td></tr>
          <tr><td>Languages:</td>
              <td><?php echo @$view->languages; ?></td>
          </tr>
