...
<div class="row">
<!-- col -->
<div class="col-md-4 add-wrap pull-left filter-left-boxes">


<aside id="electro_product_categories_widget-2" class="widget woocommerce widget_product_categories electro_widget_product_categories"><ul class="product-categories category-single"><li class="product_cat"><ul class="show-all-cat"><li class="product_cat"><span class="show-all-cat-dropdown">Choose Categories</span><ul>	
 ...
 <?php $category = getRealEstateCategory(); 
	...
	<!--<li class="cat-item cat-item-111"><a href="http://loozaa.com/demo/product-category/abayas/">Abayas</a> <span class="count">(6)</span>
</li>
	<li class="cat-item cat-item-106"><a href="http://loozaa.com/demo/product-category/accessories/">Accessories</a> <span class="count">(7)</span>
</li>
	<li class="cat-item cat-item-102"><a href="http://loozaa.com/demo/product-category/children/">children</a> <span class="count">(6)</span>
</li>
	<li class="cat-item cat-item-112"><a href="http://loozaa.com/demo/product-category/food/">Food</a> <span class="count">(8)</span>
</li>
	<li class="cat-item cat-item-114"><a href="http://loozaa.com/demo/product-category/gift/">Gift</a> <span class="count">(6)</span>
</li>
	<li class="cat-item cat-item-108"><a href="http://loozaa.com/demo/product-category/homeaccessories/">Homeaccessories</a> <span class="count">(5)</span>
</li>
	<li class="cat-item cat-item-88"><a href="http://loozaa.com/demo/product-category/mens-wear/">Mens Wear</a> <span class="count">(14)</span>
</li>
	<li class="cat-item cat-item-85"><a href="http://loozaa.com/demo/product-category/perfume/">Perfumes عطور</a> <span class="count">(11)</span>
</li>-->
</ul></li></ul><ul>	<li class="cat-item cat-item-95 current-cat"><a href="http://loozaa.com/demo/product-category/ladies-wear/">Ladies wear</a> <span class="count">(14)</span>
<ul class='children'>
	<li class="cat-item cat-item-97"><a href="http://loozaa.com/demo/product-category/ladies-wear/dresses/">Dresses                        فساتين</a> <span class="count">(3)</span>
</li>
	<li class="cat-item cat-item-100"><a href="http://loozaa.com/demo/product-category/ladies-wear/makeup/">Makeup                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;مكياج</a> <span class="count">(2)</span>
</li>
	<li class="cat-item cat-item-98"><a href="http://loozaa.com/demo/product-category/ladies-wear/perfumes/">Perfumes                      عطور</a> <span class="count">(3)</span>
</li>
	<li class="cat-item cat-item-99"><a href="http://loozaa.com/demo/product-category/ladies-wear/shoes-sandals-ladies-wear/">Shoes &amp; Sandals أحذية و نعل</a> <span class="count">(5)</span>
</li>
	<li class="cat-item cat-item-101"><a href="http://loozaa.com/demo/product-category/ladies-wear/wedding-gowns/">Wedding Gowns&nbsp;&nbsp; فساتين زفاف</a> <span class="count">(1)</span>
</li>
</ul>
</li>
</ul></li></ul></aside>
...
<ins class="adsbygoogle"
     ...
     data-ad-layout-key="-h2-z+2k-8m+eb"
     data-ad-client="ca-pub-8267866280490368"
     data-ad-slot="9775364580"></ins>
<script>
...
<div class="col-md-8 col-sm-12 listing-wrap">
  ...
  <div class="list-subcategory">
    <div class="head">Choose Category :</div>
    <!-- Nav tabs -->
    <ul class="nav nav-tabs  auto-sub realestate-sub" role="tablist">
      <li class="nav-item"> <a class="nav-link <?php if($this->input->get('property-type')==8){ echo 'active'; }elseif($this->input->get('property-type')==''){ echo 'active'; } ?> category" data-toggle="tab" id="8" href="#villas" role="tab">Villas & Lands</a> </li>
      <li class="nav-item"> <a class="nav-link <?php if($this->input->get('property-type')==4){ echo 'active'; } ?> category" data-toggle="tab" id="4" href="#appartments" role="tab">Appartments</a> </li>
      <li class="nav-item"> <a class="nav-link <?php if($this->input->get('property-type')==5){ echo 'active'; } ?> category" data-toggle="tab" id="5" href="#commercial" role="tab">Commercial Realestate</a> </li>
      <li class="nav-item"> <a class="nav-link <?php if($this->input->get('property-type')==6){ echo 'active'; } ?> category" data-toggle="tab" id="6" href="#construction" role="tab">Construction</a> </li>
    </ul>
  </div>
  <input type="hidden" value="<?php if($this->input->get('type')){ echo $this->input->get('type'); }else{ echo 'Used'; }?>" name="type" id="type">
  <input type="hidden" value="<?php if($this->input->get('property-type')){ echo $this->input->get('property-type'); }else{ echo 8; }?>" name="property-type" id="property-type">
  <!-- Nav tabs -->
  <ul class="nav nav-tabs listing-wrap new-used-switching" role="tablist" id="subnav">
    <li class="nav-item" style="width:50%"> <a class="nav-link link-radius <?php if($this->input->get('type')=='Used' || $this->input->get('type')==''){ echo 'active'; } ?>" data-toggle="tab" id="used" href="javascript:void(0);" role="tab">Rent</a> </li>
    <li class="nav-item" style="width:49%"> <a class="nav-link <?php if($this->input->get('type')=='New' && $this->input->get('type')!='New'){ echo 'active'; } ?>" data-toggle="tab" id="new" href="javascript:void(0);" role="tab">Buy</a> </li>
  </ul>
...
$(document).ready(function(e) {
	...
	$(document).on('click','.unfavorites',function(e){
		...
		<?php } ?>
		var type = $('#type').val();
		var p_type = $('#property-type').val();
		var per_page = <?php if($this->input->get('per_page')) echo $this->input->get('per_page').';'; else echo '0;'; ?>
        $.ajax({
            'url': '<?php echo base_url(); ?>real_estate/getListings?type='+type+'&property-type='+p_type+'&per_page='+per_page,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
	...
	$(document).on('click','.category',function(e){
		var id = $(this).attr('id');
		$('#property-type').val(id);
		var type = $('#type').val();
    /*if(id==6) */
		$('.result-div').hide();
        $.ajax({
            'url': '<?php echo base_url(); ?>real_estate/getListings?type='+type+'&property-type='+id/*+'&per_page='+per_page*/,
            'async': false,
            'type': "get",
            'dataType': "html",
            'success': function(data) {
