  ...
  <div class="full-wrap store-detail-wrap">
    <div class="row node-breadcrumb text-muted">
      <ol class="breadcrumb">
        ...
        <li><a href="services?category=<?php if(isset($view->category)) echo $view->category; ?>&type=<?php echo $view->type; ?>"><?php echo $view->cat; ?></a></li>
      </ol>
    </div>
    ...
    <div class="full-wrap store-detail-box-wrap"> 
      ...
      <div class="col-md-6 store-detail-box inline-block hero-radius">
        <div class="head"><i>Details</i></div>
        <ul class="list-inline row gnralbox">
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label><img src="assets/front_end/images/grid-world.png"></label>
              <span><i class="show_color"><a href="<?php echo @$view->website; ?>" target="_blank"><?php echo @$view->website; ?></a></i></span></p>
          </li>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label><img src="assets/front_end/images/telephone.png"></label>
              <span><i class="show_color"><?php echo @$view->phone; ?></i></span> </p>
          </li>
          <li class="col-xs-12 col-sm-12 col-md-12 inline-block">
            <p>
              <label><img src="assets/front_end/images/grid-world.png"></label>
              <span><i class="show_color"><?php echo @$view->s_email; ?></i></span> </p>
          </li>
          <li class="col-xs-12 col-sm-6 col-md-6 inline-block">
            <p>
              <label><img src="assets/front_end/images/printer-.png"></label>
              <span><i class="show_color"><?php echo @$view->fax; ?></i></span> </p>
          </li>
        </ul>
      </div>
      <!-- store-detail-box -->
