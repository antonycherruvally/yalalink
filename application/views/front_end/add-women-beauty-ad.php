  ...
  <div class="container">
      ...
      <div class="col-md-12">
        <div class="post-ad-wrap">
             ...
             <h3 style="color:black;">Posting Your Women & Beauty Ad </h3>
           
              <form class="m-t-15" action="insertWomenbeauty" enctype="multipart/form-data" method="post" name="post-form" id="post-form">
                  ...
                  <div class="col-md-12">
                    <label class="form-check-label mat-label-color" for="type">Choose Type:</label>
                      ...
                      <label class="radio-inline">
                        <input type="radio" name="type" id="type_1" value="Women">
                        Women </label>
                      <label class="radio-inline">
                        <input type="radio" name="type" id="type_2" value="Beauty" checked>
                        Beauty </label>
