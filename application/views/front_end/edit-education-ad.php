    ...
    <div class="row"  style="margin-top: 50px;border: 1px solid #4fc3c533;margin-bottom: 15px;padding: 18px;">
      <div class="col-md-12">
        <div class="post-ad-wrap">
           ...
           <h3 style="color:black;">Update Your Education Ad </h3>
        
              <form class="m-t-15" action="updateEducations" enctype="multipart/form-data" method="post" name="post-form" id="post-form">
                  ...
                  <div class="col-md-12">
                    <label class="form-check-label mat-label-color" for="type">Choose Type:</label>
                      ...
                      <label class="radio-inline">
                        <input type="radio" name="type" id="type_1" value="Universities" <?php if($edit->type == 'Universities'){ echo 'checked'; }?>>
                        Universities & Schools </label>
                      <label class="radio-inline">
                        <input type="radio" name="type" id="type_2" value="Institutes" <?php if($edit->type == 'Institutes'){ echo 'checked'; }?>>
                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" value="<?php echo $details->school_type; ?>" class="form-control no-border mat-txt mat-font first-txt" name="school_type" id="school_type">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      <label for="curriculum" class="bmd-label-floating">Curriculum:</label>
                      <input type="text" value="<?php echo $details->curriculum; ?>" class="form-control no-border mat-txt mat-font first-txt" name="curriculum" id="curriculum">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      <label for="inspection_rating" class="bmd-label-floating">Inspection Rating:</label>
                      <input type="text" value="<?php echo $details->inspection_rating; ?>" class="form-control no-border mat-txt mat-font first-txt" name="inspection_rating" id="inspection_rating">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      <label for="availability" class="bmd-label-floating">Availability:</label>
                      <input type="text" value="<?php echo $details->availability; ?>" class="form-control no-border mat-txt mat-font first-txt" name="availability" id="availability">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" value="<?php echo $details->status; ?>" class="form-control no-border mat-txt mat-font first-txt" name="status" id="status">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      <label for="principal" class="bmd-label-floating">Principal:</label>
                      <input type="text" value="<?php echo $details->principal; ?>" class="form-control no-border mat-txt mat-font first-txt" name="principal" id="principal">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      <label for="mobile" class="bmd-label-floating">Phone Number:</label>
                      <input type="text" value="<?php echo $edit->mobile; ?>" class="form-control no-border mat-txt mat-font first-txt" name="mobile" id="mobile">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group bmd-form-group">
                      <label for="email" class="bmd-label-floating">Email:</label>
                      <input type="text" value="<?php echo $edit->email; ?>" class="form-control no-border mat-txt mat-font first-txt" name="email" id="email">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-3">
                    <div class="card-header" id="locatioadd">Location</div>
                    <div class="form-group select-box-search bmd-form-group mat-select">
                      ...
                      <select class="js-example-basic-single" name="country" id="country" disabled>
