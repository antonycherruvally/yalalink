...
<div class="page">
  <div class="page-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="admin/classifieds">Women & beauty</a></li>
      <li class="breadcrumb-item active">Edit Women & beauty</li>
    </ol>
  </div>
        ...
        <div class="row row-lg">
          <div class="col-md-12"> 
            ...
            <div class="example-wrap">
              ...
              <?php } ?>
              <div class="example">
                <form class="form-signin cv-form" action="admin/updateWomenbeauty" enctype="multipart/form-data" method="post" name="posts_form" id="posts_form">
                    ...
                    <div class="col-md-4"> 
                      ...
                      <div class="example-wrap">
                        ...
                        <div class="radio-custom radio-primary">
                          <input type="radio"  name="type" id="type" value="Women" <?php if($edit->type == 'Women'){ echo 'checked'; } ?>/>
                          <label for="type">Women</label>
                        </div>
                        <div class="radio-custom radio-primary">
                          <input type="radio"  name="type" id="type_1" value="Beauty" <?php if($edit->type == 'Beauty'){ echo 'checked'; } ?> />
