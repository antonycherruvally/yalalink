                    ...
                    <div class="col-md-4"> 
                      ...
                      <div class="example-wrap">
                        ...
                        <div class="radio-custom radio-primary">
                          <input type="radio"  name="type" id="type" value="Maintenance" <?php if($edit->type == 'Maintenance'){ echo 'checked'; } ?>/>
                          <label for="type">Maintenance</label>
                        </div>
                        <div class="radio-custom radio-primary">
                          <input type="radio"  name="type" id="type_1" value="Services" <?php if($edit->type == 'Services'){ echo 'checked'; } ?> />
