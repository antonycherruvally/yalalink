            ...
            <div class="example-wrap">
              ...
              <div class="example">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group form-material floating">
                        ...
                        <h4><?php echo $view->school_type; ?></h4>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group form-material floating">
                        ...
                        <h4><?php echo $view->curriculum; ?></h4>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group form-material floating">
                        <label class="form-label">Inspection Rating</label>
                        <h4><?php echo $view->inspection_rating; ?></h4>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group form-material floating">
                        <label class="form-label">Availability</label>
                        <h4><?php echo $view->availability; ?></h4>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group form-material floating">
                        <label class="form-label">Education Status</label>
                        <h4><?php echo $view->education_status; ?></h4>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group form-material floating">
                        ...
                        <h4><?php echo $view->principal; ?></h4>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group form-material floating">
                        <label class="form-label">Website</label>
                        <h4><?php echo $view->website; ?></h4>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="form-group form-material">
                    <button type="submit" class="btn btn-success ladda-button" data-style="zoom-in" data-plugin="ladda" data-type="progress" id="submit_ads" onclick="location.href='admin/edit_services/<?php echo $view->post_id; ?>';">Edit</button>
                    <button type="button" class="btn btn-danger ladda-button" name="cancel" value="cancel" onClick="window.location.href='admin/services';" data-style="zoom-in" data-plugin="ladda" data-type="progress">Cancel</button>
                  </div>
              </div>
            </div>
