...
<div class="page">
  <div class="page-header">
    ...
    <div class="page-header-actions">
      <button type="button" onclick="location.href='admin/add_services';" class="btn btn-floating btn-success waves-effect waves-classic btn-sm"  data-toggle="tooltip" data-original-title="Add New"> <i class="icon md-plus" aria-hidden="true"></i> </button>
          ...
          <div class="col-lg-12"> 
            ...
            <div class="example-wrap">
              ...
              <div class="example table-responsive">
                <?php if($results){ ?>
                <form action="admin/deleteAllServices" id="list-form" method="post" enctype="multipart/form-data">
            ...
            $country = $this->admin_model->getCountry($val->country);
                      ...
                      <tr id="<?php echo $val->id; ?>">
                        ...
                        <td><button type="button" class="btn btn-floating btn-info btn-sm ladda-button" data-style="zoom-in" data-plugin="ladda" data-type="progress" data-toggle="tooltip" data-placement="top" title="Edit" onclick="location.href='admin/edit_services/<?php echo $val->id; ?>';"><i class="icon md-edit" aria-hidden="true"></i></button>
                          <button type="button" class="btn btn-floating btn-primary btn-sm ladda-button" data-style="zoom-in" data-plugin="ladda" data-type="progress" data-toggle="tooltip" data-placement="top" title="View" onclick="location.href='admin/view_services/<?php echo $val->id; ?>';"><i class="icon md-eye" aria-hidden="true"></i></button>
...
<div class="modal fade modal-info modal-3d-sign" id="DeleteRow" aria-hidden="true" aria-labelledby="DeleteRow" role="dialog" tabindex="-1">
  <div class="modal-dialog modal-center">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="admin/deleteServices" method="post" enctype="multipart/form-data">
