...
<div class="page">
  <div class="page-header">
    <h1 class="page-title">Trash Ads</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="admin/dashboard">Dashboard</a></li>
      <li class="breadcrumb-item active">Trash Ads</li>
    </ol>
          ...
          <div class="col-lg-12"> 
            ...
            <div class="example-wrap">
              ...
              <div class="example table-responsive">
                <?php if($results){ ?>
                <form action="admin/deleteAllTrashAds" id="list-form" method="post" enctype="multipart/form-data">
                  <table class="table table-hover table-responsive-md table-fixed table-striped text-center" data-plugin="selectable">
                    ...
                    <tbody>
                      ...
                      <tr id="<?php echo $val->id; ?>">
                        ...
                        <td>
                          <button type="button" class="btn btn-floating btn-primary btn-sm ladda-button" data-style="zoom-in" data-plugin="ladda" data-type="progress" data-toggle="tooltip" data-placement="top" title="Restore" onclick="location.href='admin/recover_tash/<?php echo $val->id; ?>';"><i class="icon md-circle" aria-hidden="true"></i></button>
                          <button type="button" data-target="#DeleteRow" data-toggle="modal" class="btn btn-floating btn-danger btn-sm delete" data-toggle="tooltip" data-placement="top" title="Permanent Delete"  href="javascript:void(0);">
                          <i class="icon md-delete" aria-hidden="true"></i>
                          </button>
                        </td>
  ...
  <div class="modal-dialog modal-center">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Delete Selected Ads</h4>
      </div>
      <div class="modal-body">
        <p>Are you sure, Do you want to delete permanent?…</p>
      </div>
...
<div class="modal fade modal-info modal-3d-sign" id="DeleteRow" aria-hidden="true" aria-labelledby="DeleteRow" role="dialog" tabindex="-1">
  <div class="modal-dialog modal-center">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
        <h4 class="modal-title">Delete this ads</h4>
      </div>
      <div class="modal-body">
        <p>Are you sure, Do you want delete permanent?…</p>
      </div>
      <div class="modal-footer">
        <form action="admin/deleteTrashAds" method="post" enctype="multipart/form-data">
