        ...
        <div class="row row-lg">
          <div class="col-md-12"> 
            ...
            <div class="example-wrap">
              <h4 class="example-title">Add New Education</h4>
              <?php if($this->session->flashdata('message')){ ?>
              <?php echo $this->session->flashdata('message'); ?>
              <?php } ?>
              <div class="example">
                <form class="form-signin cv-form" action="admin/insertEducation" enctype="multipart/form-data" method="post" name="posts_form" id="posts_form">
                <input type="hidden" name="main_category" value="<?php echo $this->input->get('category'); ?>">
                    ...
                    <div class="col-md-4"> 
                      ...
                      <div class="example-wrap">
                        ...
                        <div class="radio-custom radio-primary">
                          ...
                          <label for="type">Universities & Schools</label>
                        </div>
                        <div class="radio-custom radio-primary">
                          <input type="radio"  name="type" id="type_2" value="Institutes" checked />
                          <label for="type_1">Institutes & Training</label>
                        </div>
                      </div>
                      <!-- End Example Radios --> 
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <input type="text" class="form-control" name="school_type" id="school_type"/>
                    ...
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <input type="text" class="form-control" name="inspection_rating" id="inspection_rating"/>
