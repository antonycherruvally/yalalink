...
<div class="page">
  <div class="page-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="admin/education">Education</a></li>
        ...
        <div class="row row-lg">
          <div class="col-md-12"> 
            ...
            <div class="example-wrap">
              ...
              <?php } ?>
              <div class="example">
                <form class="form-signin cv-form" action="admin/updateEducation" enctype="multipart/form-data" method="post" name="posts_form" id="posts_form">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <input type="text" class="form-control" name="school_type" id="school_type" value="<?php echo $edit->school_type; ?>"/>
                        <label class="floating-label">School Type</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <input type="text" class="form-control" name="curriculum" id="curriculum" value="<?php echo $edit->curriculum; ?>"/>
                        <label class="floating-label">Curriculum</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <input type="text" class="form-control" name="inspection_rating" id="inspection_rating" value="<?php echo $edit->inspection_rating; ?>"/>
                        <label class="floating-label">Inspection Rating</label>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <input type="text" class="form-control" name="availability" id="availability" value="<?php echo $edit->availability; ?>"/>
                        <label class="floating-label">Availability</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                    ...
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <input type="text" class="form-control" name="principal" id="principal" value="<?php echo $edit->principal; ?>"/>
                        <label class="floating-label">Principal</label>
                      </div>
                    </div>
                  </div>
                  <div class="row">
