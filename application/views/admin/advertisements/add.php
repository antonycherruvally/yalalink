        ...
        <div class="row row-lg">
          <div class="col-md-12"> 
            ...
            <div class="example-wrap">
              ...
              <?php } ?>
              <div class="example">
                <form class="form-signin cv-form" action="admin/insertAdvertisement" enctype="multipart/form-data" method="post" name="advertisement_form" id="advertisement_form">
                  <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <select class="form-control" data-plugin="select2" data-placeholder="Select type" data-allow-clear="true" name="type" id="type">
                          <option></option>
                          <option value="Header Ads">Header Ads</option>
                          <option value="Right Side Ads">Right Side Ads</option>
                          <option value="Center Ads">Center Ads</option>
                        </select>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <select class="form-control" data-plugin="select2" data-placeholder="Select the page" data-allow-clear="true" name="country" id="country">
                          <option></option>
                          <?php $country = getCountries(); if($country){ foreach($country as $val){ ?>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group bmd-form-group mat-select">
                      ...
                      <select multiple="multiple" size="10" name="page[]" id="page">
                        <?php $page = array('Home','About Us','Contact Us','FAQS','Content Guidelines','Terms','Privacy','Site Map','Real Estate','Jobs','Auto','Classifieds','House Maids','Phones','Electronics','Computers','Education','Services');
								if($page){
								foreach($page as $val){
