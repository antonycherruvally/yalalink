...
<div class="page">
  <div class="page-header">
    ...
    <div class="page-header-actions">
      <button type="button" onclick="location.href='admin/add_advertisements';" class="btn btn-floating btn-success waves-effect waves-classic btn-sm"  data-toggle="tooltip" data-original-title="Add New"> <i class="icon md-plus" aria-hidden="true"></i> </button>
          ...
          <div class="col-lg-12"> 
            ...
            <div class="example-wrap">
              ...
              <div class="example table-responsive">
                <?php if($results){ ?>
                <form action="admin/deleteAllAdvertisement" id="list-form" method="post" enctype="multipart/form-data">
                  <table class="table table-hover table-responsive-md table-fixed table-striped text-center" data-plugin="selectable">
                    ...
                    <tbody>
                      ...
                      $title = preg_replace("/[^a-zA-Z0-9 ]+/", "", $val->title);
                      ...
                      <tr id="<?php echo $val->id; ?>">
                        ...
                        <td><?php if($val->status == 1) { echo '<span class="badge badge-round badge-success">Active</span>'; }else{ echo '<span class="badge badge-round badge-danger">InActive</span>'; } ?></td>
                        <td><a class="btn btn-floating btn-info btn-sm ladda-button" data-style="zoom-in" data-plugin="ladda" data-type="progress" data-toggle="tooltip" data-placement="top" title="Edit" href="admin/edit_advertisement/<?php echo $val->id; ?>"><i class="icon md-edit" aria-hidden="true"></i></a>
                          <a class="btn btn-floating btn-primary btn-sm ladda-button" data-style="zoom-in" data-plugin="ladda" data-type="progress" data-toggle="tooltip" data-placement="top" title="View" href="admin/view_advertisement/<?php echo $val->id; ?>"><i class="icon md-eye" aria-hidden="true"></i></a>
  ...
  <div class="modal-dialog modal-center">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Delete Selected Advertisements</h4>
      </div>
      <div class="modal-body">
        <p>Are you sure, you want to delete the selected advertisements?…</p>
      </div>
...
<div class="modal fade modal-info modal-3d-sign" id="DeleteRow" aria-hidden="true" aria-labelledby="DeleteRow" role="dialog" tabindex="-1">
  <div class="modal-dialog modal-center">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
        <h4 class="modal-title">Delete Advertisements</h4>
      </div>
      <div class="modal-body">
        <p>Are you sure, you want to delete this advertisements?…</p>
      </div>
      <div class="modal-footer">
        <form action="admin/deleteAdvertisement" method="post" enctype="multipart/form-data">
