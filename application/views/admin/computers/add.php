...
<div class="page">
  <div class="page-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="admin/computers">Computers</a></li>
      <li class="breadcrumb-item active">Add Computers</li>
    </ol>
  </div>
        ...
        <div class="row row-lg">
          <div class="col-md-12"> 
            ...
            <div class="example-wrap">
              <h4 class="example-title">Add New Computers</h4>
              <?php if($this->session->flashdata('message')){ ?>
              <?php echo $this->session->flashdata('message'); ?>
              <?php } ?>
              <div class="example">
                <form class="form-signin cv-form" action="admin/insertComputers" enctype="multipart/form-data" method="post" name="posts_form" id="posts_form">
                  <div class="row">
                    <div class="col-md-4"> 
                      <!-- Example Radios -->
                      <div class="example-wrap">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        ...
                        <?php $category = getComputersCategories(); 
            ...
            if($mo_category_type){ foreach ($mo_category_type as $val) { ?>
                    ...
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <select class="form-control mouse" data-plugin="select2" data-placeholder="Choose Color" data-allow-clear="true" name="color" id="mo_color" >
                         <option value="">Select Color</option>
                        <?php $color = getColors(); 
            if($color){ foreach($color as $val){?>
                        <option value="<?php echo $val->name; ?>"><?php echo $val->name; ?></option>
