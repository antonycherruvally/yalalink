...
<div class="page">
  <div class="page-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Add New Classifieds</li>
    </ol>
  </div>
        ...
        <div class="row row-lg">
          <div class="col-md-12"> 
            ...
            <div class="example-wrap">
              <h4 class="example-title">Add New Classifieds</h4>
              <?php if($this->session->flashdata('message')){ ?>
              <?php echo $this->session->flashdata('message'); ?>
              <?php } ?>
              <div class="example">
                <form class="form-signin cv-form" action="admin/insertClassifieds" enctype="multipart/form-data" method="post" name="posts_form" id="posts_form">
                  <div class="row">
                    <div class="col-md-4"> 
                      <!-- Example Radios -->
                      <div class="example-wrap">
              ...
              $selected = 'selected';
                    ...
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        ...
                        <label class="floating-label">Price (<?php echo @$currency; ?>):</label>
                      </div>
                    </div>
                  </div>
                  <div class="row">
              ...
              if($res->country_code == $val->code){
                $selected = 'selected';
                  ...
                  <div class="form-group form-material">
                    ...
                    <button type="button" class="btn btn-danger ladda-button" data-style="zoom-in" data-plugin="ladda" data-type="progress" name="cancel" value="cancel" onClick="window.location.href='admin/classifieds';">Cancel</button>
                  </div>
                </form>
              </div>
            </div>
...
(function (global, factory) {
  ...
  function getSub(id,cat) {
    $.ajax({
        'url': '<?php echo base_url(); ?>get_classifieds_subcategory/' + id +'/' + cat,
        'async': false,
        'type': "get",
        'dataType': "html",
        'success': function(data) {
