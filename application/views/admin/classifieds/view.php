                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group form-material floating">
                        ...
                        <?php $category = $this->admin_model->getClassifiedsSubCategory($view->category); ?>
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group form-material floating">
                        ...
                        <?php $subcategory = $this->admin_model->getClassifiedsSubCategory($view->subcategory); ?>
