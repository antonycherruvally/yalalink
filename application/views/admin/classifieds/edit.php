        ...
        <div class="row row-lg">
          <div class="col-md-12"> 
            ...
            <div class="example-wrap">
              ...
              <?php } ?>
              <div class="example">
                <form class="form-signin cv-form" action="admin/updateClassifieds" enctype="multipart/form-data" method="post" name="posts_form" id="posts_form">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <input type="text" class="form-control" name="contact" id="contact" value="<?php echo $edit->phone; ?>"/>
...
function deleteImage(id,type){
  ...
  getSub($('#category').val(),<?php echo $edit->subcategory; ?>);
