...
<div class="page">
  <div class="page-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="admin/real_estate">Real Estate</a></li>
      <li class="breadcrumb-item active">Edit Real Estate</li>
    </ol>
  </div>
        ...
        <div class="row row-lg">
          <div class="col-md-12"> 
            ...
            <div class="example-wrap">
              <h4 class="example-title">Edit Real Estate</h4>
              <?php if($this->session->flashdata('message')){ ?>
              <?php echo $this->session->flashdata('message'); ?>
              <?php } ?>
              <div class="example">
                <form class="form-signin cv-form" action="admin/updateRealEstate" enctype="multipart/form-data" method="post" name="posts_form" id="posts_form">
                  ...
                  <div class="row">
                   <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <select class="form-control" data-plugin="select2" data-placeholder="Select Purpose" data-allow-clear="true" name="purpose" id="purpose" >
                          <option></option>
                          <?php $category = getRealEstatePurpose(); 
            if($category){ foreach($category as $val){
            $selected = '';
            if($edit->purpose == $val->id){
              $selected = 'selected';
            }?>
                    ...
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <select class="form-control" data-plugin="select2" data-placeholder="Select Property Type" data-allow-clear="true" name="property_type" id="property_type" >
                          <option></option>
                          <?php $category = getRealEstateCategory(); 
            if($category){ foreach($category as $val){
            $selected = '';
            if($edit->property_type == $val->id){
              $selected = 'selected';
            }?>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <select class="form-control" data-plugin="select2" data-placeholder="Select Price Per Year/Month" data-allow-clear="true" name="price_per" id="price_per" >
                         <option></option>
                          <option value="Year" <?php if($edit->price_per == 'Year'){ echo 'selected'; } ?>>Year</option>
                          <option value="Month" <?php if($edit->price_per == 'Month'){ echo 'selected'; } ?>>Month</option>
                        </select>
                        <label class="floating-label"></label>
                      </div>
                    </div>
                    <div class="col-md-4 residential">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <select class="form-control" data-plugin="select2" data-placeholder="Select Bedrooms" data-allow-clear="true" name="bedrooms" id="bedrooms" >
                          <option></option>
                          <option value="Studio" <?php if($edit->bedroom == 'Studio'){ echo 'selected'; } ?>>Studio</option>
                          <option value="1" <?php if($edit->bedroom == 1){ echo 'selected'; } ?>>1</option>
                          <option value="2" <?php if($edit->bedroom == 2){ echo 'selected'; } ?>>2</option>
                          <option value="3" <?php if($edit->bedroom == 3){ echo 'selected'; } ?>>3</option>
                          <option value="4" <?php if($edit->bedroom == 4){ echo 'selected'; } ?>>4</option>
                          <option value="5" <?php if($edit->bedroom == 5){ echo 'selected'; } ?>>5</option>
                          <option value="5+" <?php if($edit->bedroom == '5+'){ echo 'selected'; } ?>>5+</option>
                        </select>
                        <label class="floating-label"></label>
                      </div>
                    ...
                    <div class="col-md-4 residential">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <select class="form-control" data-plugin="select2" data-placeholder="Select Bathrooms" data-allow-clear="true" name="bathrooms" id="bathrooms" >
                          <option></option>
                          <option value="1" <?php if($edit->bathroom == 1){ echo 'selected'; } ?>>1</option>
                          <option value="2" <?php if($edit->bathroom == 2){ echo 'selected'; } ?>>2</option>
                          <option value="3" <?php if($edit->bathroom == 3){ echo 'selected'; } ?>>3</option>
                          <option value="4" <?php if($edit->bathroom == 4){ echo 'selected'; } ?>>4</option>
                          <option value="5" <?php if($edit->bathroom == 5){ echo 'selected'; } ?>>5</option>
                          <option value="5+" <?php if($edit->bathroom == '5+'){ echo 'selected'; } ?>>5+</option>
                        </select>
                        <label class="floating-label"></label>
                      </div>
                     ...
                     <div class="col-md-4 residential">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <select class="form-control" data-plugin="select2" data-placeholder="Select Car garage" data-allow-clear="true" name="garage" id="garage" >
                          <option></option>
                          <option value="1" <?php if($edit->garage == 1){ echo 'selected'; } ?>>1</option>
                          <option value="2" <?php if($edit->garage == 2){ echo 'selected'; } ?>>2</option>
                          <option value="3" <?php if($edit->garage == '3+'){ echo 'selected'; } ?>>3+</option>
                     ...
                     <div class="col-md-4 residential">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <select class="form-control" data-plugin="select2" data-placeholder="Select Swimming pool" data-allow-clear="true" name="pool" id="pool" >
                          <option></option>
                           <option value="1" <?php if($edit->pool == 1){ echo 'selected'; } ?>>1</option>
                          <option value="2" <?php if($edit->pool == 2){ echo 'selected'; } ?>>2</option>
                          <option value="3" <?php if($edit->pool == '3+'){ echo 'selected'; } ?>>3+</option>
                    ...
                    <div class="col-md-4 residential">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <select class="form-control" data-plugin="select2" data-placeholder="Select Balcony" data-allow-clear="true" name="balcony" id="balcony" >
                          <option></option>
                          < <option value="1" <?php if($edit->balcony == 1){ echo 'selected'; } ?>>1</option>
                          <option value="2" <?php if($edit->balcony == 2){ echo 'selected'; } ?>>2</option>
                          <option value="3" <?php if($edit->balcony == '3+'){ echo 'selected'; } ?>>3+</option>
                    ...
                    <div class="col-md-4">
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <input type="text" class="form-control" name="size" id="size" value="<?php echo $edit->size; ?>"/>
                        <label class="floating-label">Size (SqFt):</label>
                      </div>
                    </div>
                  </div>
                ...
                if($amenity){
                  ...
                  <div class="row commercial">
                    <div class="col-md-12">
                      ...
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <label for="amenities" class="mat-label-color">Choose Facilities & Amenities::</label>
                        <select multiple="multiple" size="10" name="amenities[]" id="com_amenities">
              ...
              if($edit->country == $val->id){
                $selected = 'selected';
                  ...
                  <div class="form-group form-material">
                    ...
                    <button type="button" class="btn btn-danger ladda-button" data-style="zoom-in" data-plugin="ladda" data-type="progress" name="cancel" value="cancel" onClick="window.location.href='admin/real_estate';">Cancel</button>
                  </div>
                </form>
              </div>
            </div>
...
$(document).ready(function(e) {
	...
	$('#property_type').change(function(e) {
		if ($('#property_type').val() == 4 || $('#property_type').val() == 5 || $('#property_type').val() == 9 || $('#property_type').val() == 11 || $('#property_type').val() == 14 || $('#property_type').val() == 15) {
            $('.residential').show();
            $('.commercial').hide();
            $("#co_amenities").prop('disabled', true);
            $("#re_amenities").prop('disabled', false);
		}else if ($('#property_type').val() == 8 || $('#property_type').val() == 6 || $('#property_type').val() == 7) {
            $('.residential').hide();
            $('.commercial').show();
