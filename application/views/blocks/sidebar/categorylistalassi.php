...
">
					...
					foreach( $cats as $ct ) {
						...
						?>
						 <div class="col-sm-<?php echo $bootstrapColWidth; ?> col-xs-<?php echo $bootstrapColWidth; ?> ">
							<div class="sidenewbtn nav-link <?= $act ?> category" data-toggle="tab" id="<?= $ct->id ?>" href="javascript:void(0)" role="tab" style=" width: 87px;
    font-size: 10px;
    ...
    if($rowCount % $numOfCols == 0) echo '</div><div class="row nextrow" >';
		...
		<div class="filterbtn filterclassi">Filter بحث متقدم
</div>
</aside>