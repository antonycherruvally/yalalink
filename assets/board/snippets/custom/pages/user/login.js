        ...
        init: function() {
            e(), $("#m_login_signin_submit").click(function(e) {
                ...
                r.validate({
                    ...
                    url: site.baseUrl + 'board/authenticate',
                    success: function(e, i, a, l) {
                    	if( e.status == 'success' ) {
                    		t.removeClass("m-loader m-loader--right m-loader--light").attr("disabled", !1), n(r, "success", "Successfully login...");
                    		var uri = getUrlVars()['redirect'];
                            if( uri ) {
                                window.location.replace(uri);
                                return;
                            }
                            window.location.replace(site.baseUrl + 'board');
                    	}else{
