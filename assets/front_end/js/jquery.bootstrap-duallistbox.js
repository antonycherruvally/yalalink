  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        '     <button type="button" class="btn btn-raised hero-radius btn-644e97 mat-submit clear1 pull-right"></button>' +
        '   </span>' +
        '   <input class="filter" type="text">' +
        '   <div class="btn-group buttons">' +
        '     <button type="button" class="btn btn-raised hero-radius btn-644e97 mat-submit moveall">' +
        '       <i></i>' +
        '       <i></i>' +
        '     </button>' +
        '     <button type="button" class="btn btn-raised hero-radius btn-644e97 mat-submit move">' +
        '       <i></i>' +
        '     </button>' +
        '   </div>' +
        ...
        '   <span class="info-container">' +
        '     <span class="info"></span>' +
        '     <button type="button" class="btn btn-raised hero-radius btn-644e97 mat-submit clear2 pull-right"></button>' +
        '   </span>' +
        '   <input class="filter" type="text">' +
        '   <div class="btn-group buttons">' +
        '     <button type="button" class="btn btn-raised hero-radius btn-644e97 mat-submit remove">' +
        '       <i></i>' +
        '     </button>' +
        '     <button type="button" class="btn btn-raised hero-radius btn-644e97 mat-submit removeall">' +
        '       <i></i>' +
        '       <i></i>' +
        '     </button>' +
        '   </div>' +
